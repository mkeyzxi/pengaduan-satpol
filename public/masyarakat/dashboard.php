...
<body class="p-3">
<a class="btn btn-secondary mb-2" href="/public/login.php?logout=1">Logout</a>
<h4>Riwayat Pengaduan Anda</h4>
<a class="btn btn-primary mb-3" href="buat_pengaduan.php">Buat Pengaduan Baru</a>

<table class="table table-striped">
<thead><tr><th>ID</th><th>Kategori</th><th>Prediksi</th><th>Status</th><th>Waktu</th></tr></thead>
<tbody>
